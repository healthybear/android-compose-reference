...
### [x] OPT-010 按需加载 Element Plus 并清理依赖
...
- 移除了 `pinia`、`@vueuse/core`、`dayjs`、`sass` 未使用的依赖
- 主 JS 体积从 1,380.08 kB (gzip: 423.51 kB) 降至 475.90 kB (gzip: 142.71 kB)
- 体积减少约 66%，构建时间从 ~8s 降至 ~6s
